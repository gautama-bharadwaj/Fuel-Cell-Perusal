...
$pdf->Cell(190,5,'VERSION USED: v2.2.1',0,1);
...
$pdf->Cell($width_cell[0],10,'MEMBRANE THICKNESS',1,0,false); // First column of row 3
$pdf->Cell($width_cell[1],10,$L_mem,1,0,false); // Second column of row 3
$pdf->Cell($width_cell[2],10,'cm',1,1,false); // Third column of row 3
...
$pdf->Cell($width_cell[0],10,'PARTIAL PRESSURE OF OXYGEN(PO2)',1,0,false); // First column of row 3
$pdf->Cell($width_cell[1],10,$PO2,1,0,false); // Second column of row 3
$pdf->Cell($width_cell[2],10,'Bar',1,1,false); // Third column of row 3

$pdf->Cell($width_cell[0],10,'ACTIVE CELL AREA',1,0,false); // First column of row 3
$pdf->Cell($width_cell[1],10,$Area,1,0,false); // Second column of row 3
$pdf->Cell($width_cell[2],10,'cm2',1,1,false); // Third column of row 3
$pdf->Ln(20);
$pdf->SetFont('Arial','B',14);
...
$pdf->Image('Chart_images/4a.png',8,60,200);
$pdf->Image('Chart_images/4b.png',8,150,200);
$pdf->AddPage();
$pdf->Image('Chart_images/4c.png',8,60,200);
$pdf->Image('Chart_images/4d.png',8,150,200);
/*$pdf = new FPDF();
$pdf->AddPage();*/
