...
$pdf->Cell(190,5,'VERSION USED:v1.1.1',0,1);
...
$pdf->Cell($width_cell[0],10,'NUMBER OF CELLS',1,0,false); // First column of row 3
$pdf->Cell($width_cell[1],10,$No,1,0,false); // Second column of row 3
$pdf->Cell($width_cell[2],10,'---',1,1,false); // Third column of row 3
...
$pdf->Image('Chart_images/3a.png',8,60,200);
